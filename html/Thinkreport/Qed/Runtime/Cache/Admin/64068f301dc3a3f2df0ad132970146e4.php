...
<a  class="btn btn-info btn-small"  id="modal-9735581" href="<?php echo U('Find/editFind',array('menuname'=>'添加文字模板'));?>" role="button" ><i class="icon-plus icon-white"></i>添加所见标题
</a>
</span>
<strong>所见意见</strong>
</div>
<form method="get" name='form'>
      <table style="width:100%;">
        ...
        所见标题：<input type="search" name='tblfinding_title' value="<?php echo ($_GET['tblfinding_title']); ?>" />
...
<table class="table table-bordered table-striped table-hover">
     <tbody>
       <tr align="center">
         ...
         <td nowrap="nowrap" style="width:25%;"><strong>所见标题</strong></td>
         <td nowrap="nowrap" style="width:25%;"><strong>所见用户(0:公有，非0:私有)</strong></td>
      ...
      <?php if($list): if(is_array($list)): foreach($list as $key=>$val): ?><tr align="center" class='itemChange'>
         <td nowrap="nowrap"><?php echo ($val['tblfinding_id']); ?></td>
         <td nowrap="nowrap"><?php echo ($val['tblfinding_title']); ?></td>
         <td nowrap="nowrap"><?php echo ($val['tbluser_id']); ?></td>
         <td nowrap="nowrap">
         <input type="hidden" class='id' value="<?php echo ($val["tblfinding_id"]); ?>" />
	         <a href="<?php echo U('Find/findsub',array('tblfinding_ID'=>$val['tblfinding_id']));?>">【所见内容】</a>&nbsp;&nbsp;
	         <a href="<?php echo U('Find/editFind',array('menuname'=>'修改文字模板','id'=>$val['tblfinding_id']));?>">【修改】</a>&nbsp;&nbsp;
