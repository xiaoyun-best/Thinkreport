...
<div class="right"  id="mainFrame">
    <div class="right_cont">
        ...
        <form method="post" action="/Admin/Tracer/editTracer"  enctype="multipart/form-data">
            <table>
                <tbody>
                <input type="hidden"name="id" value="<?php echo ($vol["tbltracer_id"]); ?>" />
                <tr>
                    <td align="right">示踪器:</td>
                    <td align="left">
                        <input name="tbltracer_tracer" type="text" value="<?php echo ($vol['tbltracer_tracer']); ?>"/>
                    </td>
                </tr>
                <tr>
                    <td align="right">半衰期:</td>
                    <td align="left">
                        <input name="tbltracer_method" type="text" value="<?php echo ($vol['tbltracer_method']); ?>"/>
                    </td>
                </tr>
                </tbody>
            </table>
