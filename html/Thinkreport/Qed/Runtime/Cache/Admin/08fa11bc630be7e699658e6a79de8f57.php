...
<div class="right"  id="mainFrame">
    <div class="right_cont">
        ...
        <form method="post" action="/Admin/Menu/editMenu" enctype="multipart/form-data">
            <table>
                <tbody>
                <input type="hidden"name="id" value="<?php echo ($vol["tblmenu_id"]); ?>" />
                <tr>
                ...
                <tr>
                    ...
                    <td align="left"><input name="tblmenu_name" type="text" value="<?php echo ($vol['tblmenu_name']); ?>"/></td>
                </tr>
                <tr>
                    <td align="right">菜单地址:</td>
                    <td align="left"><input name="tblmenu_url" type="text" value="<?php echo ($vol['tblmenu_url']); ?>"/></td>
                </tr>
                </tbody>
            </table>
            <div class="page_btm">
