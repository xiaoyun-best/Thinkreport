...
<div class="right"  id="mainFrame">
    <div class="right_cont">
        ...
        <form method="post" action="/Admin/Custom/editCustom"  enctype="multipart/form-data">
            <table>
                <tbody>
                <input type="hidden"name="id" value="<?php echo ($vol["tblcustom_id"]); ?>" />
                <tr>
                    <td align="right">自定义字段名称:</td>
                    <td align="left">
                        <input name="tblcustom_name" type="text" value="<?php echo ($vol['tblcustom_name']); ?>"/>
                    </td>
                </tr>
                <tr>
                    <td align="right">显示名:</td>
                    <td align="left">
                        <input name="tblcustom_displayname" type="text" value="<?php echo ($vol['tblcustom_displayname']); ?>"/>
                    </td>
                </tr>
                </tbody>
            </table>
