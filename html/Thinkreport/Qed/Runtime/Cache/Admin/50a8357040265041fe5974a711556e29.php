...
<a  class="btn btn-info btn-small"  id="modal-9735581" href="<?php echo U('Find/editFindsub',array('menuname'=>'添加所见内容'));?>" role="button" ><i class="icon-plus icon-white"></i>添加所见内容
</a>
</span>
<strong>所见内容</strong>
</div>
<form method="get" name='form'>
      <table style="width:100%;">
        ...
        所见内容：<input type="search" name='tblfinding_title' value="<?php echo ($_GET['tblfinding_title']); ?>" />
...
<table class="table table-bordered table-striped table-hover">
     <tbody>
       <tr align="center">
         ...
         <td nowrap="nowrap" style="width:25%;"><strong>子标题</strong></td>
         <td nowrap="nowrap" style="width:25%;"><strong>检查所见</strong></td>
         <td nowrap="nowrap" style="width:25%;"><strong>诊断意见</strong></td>
      ...
      <?php if($list): if(is_array($list)): foreach($list as $key=>$val): ?><tr align="center" class='itemChange'>
         <td nowrap="nowrap"><?php echo ($val['tblfindingsub_id']); ?></td>
         <td nowrap="nowrap"><?php echo ($val['tblfindingsub_subtitle']); ?></td>
         <td nowrap="nowrap"><?php echo (mb_substr($val['tblfindingsub_finding'],0,3)); ?>......<?php echo (mb_substr($val['tblfindingsub_finding'],-4,-1)); ?></td>
         <td nowrap="nowrap"><?php echo (mb_substr($val['tblfindingsub_suggest'],0,3)); ?>......<?php echo (mb_substr($val['tblfindingsub_suggest'],-4,-1)); ?></td>
         <td nowrap="nowrap">
         <input type="hidden" class='id' value="<?php echo ($val["tblfindingsub_id"]); ?>" />
	         <a href="<?php echo U('Find/editFindsub',array('menuname'=>'修改所见内容','id'=>$val['tblfindingsub_id'],'tblfinding_ID'=>$tblfinding_ID));?>">【修改】</a>&nbsp;&nbsp;
...
$('.delete').on('click',function(){
  if(confirm('确定要删除吗？')){
    ...
    window.location.href='/Admin/Find/del/id/'+id;
  }
})
</script>
