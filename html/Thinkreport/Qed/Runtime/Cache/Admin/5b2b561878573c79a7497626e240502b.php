...
<div class="right"  id="mainFrame">
    <div class="right_cont">
        ...
        <form method="post" action="/Admin/Find/editFind" name='editpsd' enctype="multipart/form-data">
            <table>
                <tbody>
                <input type="hidden"name="id" value="<?php echo ($vol["tblfinding_id"]); ?>" />
                <tr>
                    <td align="right">所见标题:</td>
                    <td align="left"><input name="tblfinding_title" type="text" value="<?php echo ($vol['tblfinding_title']); ?>"/></td>
                </tr>
                </tbody>
            </table>
            <div class="page_btm">
