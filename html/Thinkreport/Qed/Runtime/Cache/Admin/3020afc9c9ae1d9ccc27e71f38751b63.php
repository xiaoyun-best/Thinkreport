...
<div class="right"  id="mainFrame">
    <div class="right_cont">
        ...
        <form method="post" action="/Admin/Depart/editDepart" name='editpsd' enctype="multipart/form-data">
            <table>
                <tbody>
                <input type="hidden"name="id" value="<?php echo ($vol["tbldepartment_id"]); ?>" />
                <tr>
                    <td align="right">科室:</td>
                    <td align="left"><input name="tbldepartment_department" type="text" value="<?php echo ($vol['tbldepartment_department']); ?>"/></td>
                </tr>
                </tbody>
            </table>
            <div class="page_btm">
