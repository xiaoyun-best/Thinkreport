...
<div class="right"  id="mainFrame">
    <div class="right_cont">
        ...
        <form method="post" action="/Admin/Item/editItem"  enctype="multipart/form-data">
            <table>
                <tbody>
                <input type="hidden"name="id" value="<?php echo ($vol["tblinspectionitem_id"]); ?>" />
                <tr>
                    <td align="right">检查项目:</td>
                    <td align="left"><input name="tblInspectionItem_item" type="text" value="<?php echo ($vol['tblinspectionitem_item']); ?>"/></td>
                </tr>
                </tbody>
            </table>
            <div class="page_btm">
