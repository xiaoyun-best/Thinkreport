...
<div class="right"  id="mainFrame">
    <div class="right_cont">
        ...
        <div class="title_right"><span class="pull-right margin-bottom-5"><a  class="btn btn-info btn-small"  id="modal-9735581" href="<?php echo U('Role/editRole',array('menuname'=>'添加角色'));?>" role="button" ><i class="icon-plus icon-white"></i>添加角色</a></span><strong>角色列表</strong></div>
        <form method="get" name='form'>
            <table style="width:100%;">
                <tr align="left">
                    <td  align="left" nowrap="nowrap" bgcolor="#f1f1f1" >
                        角色名称：<input type="search" name='tblrole_name'  value="<?php echo ($_GET['tblrole_name']); ?>" />
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            <tr align="center">
                ...
                <td nowrap="nowrap" style="width:25%;"><strong>角色名称</strong></td>
                <td nowrap="nowrap" style="width:25%;"><strong>备注</strong></td>
            ...
            <?php if($list): if(is_array($list)): foreach($list as $key=>$val): ?><tr align="center" class='itemChange'>
                        <td nowrap="nowrap"><?php echo ($val['tblrole_id']); ?></td>
                        <td nowrap="nowrap"><?php echo ($val['tblrole_name']); ?></td>
                        <td nowrap="nowrap"><?php echo ($val['tblrole_content']); ?></td>
                        <td nowrap="nowrap"><?php echo ($val['tblrole_adduser']); ?></td>
                        <td nowrap="nowrap"><?php echo ($val['tblrole_edittime']); ?></td>
                        <td nowrap="nowrap"><input type="hidden" class='id' value="<?php echo ($val["tblrole_id"]); ?>" />
                            <a href="<?php echo U('Rolenode/nodelist',array('rid'=>$val['tblrole_id'],'rolename'=>$val['tblrole_name']));?>">【设置权限】</a>
                            <a href="<?php echo U('Role/editRole',array('menuname'=>'修改角色','id'=>$val['tblrole_id']));?>">【修改】</a>
...
<script type="text/javascript">
    ...
    $('.delete').on('click',function(){
        if(confirm('确定要删除吗？')){
            ...
            window.location.href='/Admin/Role/del/id/'+id;
        }
    })
</script>
