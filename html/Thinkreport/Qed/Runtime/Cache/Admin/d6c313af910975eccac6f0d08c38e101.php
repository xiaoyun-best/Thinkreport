...
<div class="right"  id="mainFrame">
    <div class="right_cont">
        ...
        <div class="title_right"><span class="pull-right margin-bottom-5"><a  class="btn btn-info btn-small"  id="modal-9735581" href="<?php echo U('Menu/editMenu',array('menuname'=>'添加菜单'));?>" ><i class="icon-plus icon-white"></i>添加菜单</a></span><strong>菜单列表</strong></div>
        <form method="get" name='form'>
            <table style="width:100%;">
                <tr align="left">
                    <td  align="left" nowrap="nowrap" bgcolor="#f1f1f1" >
                        菜单名称：<input type="search" name='tblmenu_name'  value="<?php echo ($_GET['tblmenu_name']); ?>" />
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            <tr align="center">
                ...
                <td nowrap="nowrap" style="width:25%;"><strong>菜单名称</strong></td>
            ...
            <?php if($list): if(is_array($list)): foreach($list as $key=>$val): ?><tr align="center" class='itemChange'>
                        ...
                        <td nowrap="nowrap"><input type="hidden" class='id' value="<?php echo ($val["tblmenu_id"]); ?>" />
                            <a href="<?php echo U('Menu/menusub',array('id'=>$val['tblmenu_id']));?>">【查看子菜单】</a>
                            <a href="<?php echo U('Menu/editMenu',array('menuname'=>'修改菜单','id'=>$val['tblmenu_id']));?>">【修改】</a>&nbsp;&nbsp;
