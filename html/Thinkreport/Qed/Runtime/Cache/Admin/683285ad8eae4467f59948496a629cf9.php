...
<div class="right"  id="mainFrame">
    <div class="right_cont">
        ...
        <div class="title_right"><strong><?php echo ($menuname); ?>：
            ...
            <form method="post" action="/Admin/Role/editRole" enctype="multipart/form-data">
                <table>
                    <tbody>
                    <input type="hidden"name="id" value="<?php echo ($vol["tblrole_id"]); ?>" />
                    <tr>
                        <td align="right">角色名称:</td>
                        <td align="left"><input name="tblrole_name" type="text" value="<?php echo ($vol['tblrole_name']); ?>"/></td>
                    </tr>
                    <tr>
                        <td align="right">备注:</td>
                        <td align="left"><input name="tblrole_content" type="text" value="<?php echo ($vol['tblrole_content']); ?>"/></td>
                    </tr>
                    </tbody>
                </table>
                <div class="page_btm">
