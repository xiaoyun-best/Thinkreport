...
<div class="right"  id="mainFrame">
    <div class="right_cont">
        ...
        <form method="post" action="/Admin/Area/editArea" name='editpsd' enctype="multipart/form-data">
            <table>
                <tbody>
                <input type="hidden"name="id" value="<?php echo ($vol["tblinpatientarea_id"]); ?>" />
                <tr>
                    <td align="right">病区:</td>
                    <td align="left"><input name="tblInpatientArea_area" type="text" value="<?php echo ($vol['tblinpatientarea_area']); ?>"/></td>
                </tr>
                </tbody>
            </table>
            <div class="page_btm">
