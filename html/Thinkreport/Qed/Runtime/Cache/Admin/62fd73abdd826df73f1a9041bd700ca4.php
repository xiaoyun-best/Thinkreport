...
<div class="title_right"><span class="pull-right margin-bottom-5"><a  class="btn btn-info btn-small"  id="modal-9735581" href="<?php echo U('Tracer/editTracer',array('menuname'=>'添加示踪器'));?>" role="button" ><i class="icon-plus icon-white"></i>添加示踪器</a></span><strong>示踪器列表</strong></div>

 <form method="get" name='form'>
      <table style="width:100%;">
        <tr align="left">
        <td  align="left" nowrap="nowrap" bgcolor="#f1f1f1" >
        示踪剂：<input type="search" name='tbltracer_tracer' value="<?php echo ($_GET['tbltracer_tracer']); ?>" />
...
<table class="table table-bordered table-striped table-hover">
     <tbody>
       <tr align="center">
         ...
         <td nowrap="nowrap" style="width:25%;"><strong>示踪器</strong></td>
           <td nowrap="nowrap" style="width:25%;"><strong>半衰期</strong></td>
      ...
      <?php if($list): if(is_array($list)): foreach($list as $key=>$val): ?><tr align="center" class='itemChange'>
         <td nowrap="nowrap"><?php echo ($val['tbltracer_id']); ?></td>
         <td nowrap="nowrap"><?php echo ($val['tbltracer_tracer']); ?></td>
         <td nowrap="nowrap"><?php echo ($val['tbltracer_method']); ?></td>
         <td nowrap="nowrap"><input type="hidden" class='id' value="<?php echo ($val["tbltracer_id"]); ?>" /><a href="<?php echo U('Tracer/editTracer',array('menuname'=>'修改示踪器','id'=>$val['tbltracer_id']));?>">【修改】</a>&nbsp;&nbsp;<a class='delete' style="cursor:pointer;">【删除】</a>
...
$('.delete').on('click',function(){
  if(confirm('确定要删除吗？')){
    ...
    window.location.href='/Admin/Tracer/del/id/'+id;
  }
})
</script>
