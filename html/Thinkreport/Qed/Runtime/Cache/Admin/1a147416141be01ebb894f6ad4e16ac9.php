...
<div class="right"  id="mainFrame">
  <div class="right_cont">
    ...
    <form method="post" action="/Admin/Find/editFindsub"  enctype="multipart/form-data">
      <table>
        <tbody>
        <input type="hidden"name="id" value="<?php echo ($vol["tblfindingsub_id"]); ?>" />
        <input type="hidden"name="tblfinding_ID" value="<?php echo ($tblfinding_ID); ?>" />
        <tr>
          <td align="right">子标题:</td>
          <td align="left"><input name="tblfindingsub_subtitle" type="text" value="<?php echo ($vol['tblfindingsub_subtitle']); ?>"/></td>
        </tr>
        <tr>
          <td align="right">检查所见:</td>
          <td align="left"><textarea name="tblfindingsub_finding" cols="60" rows="35" style="width: 200px; height: 100px;"><?php echo ($vol['tblfindingsub_finding']); ?></textarea> </td>
        </tr>
        <tr>
          <td align="right">诊断意见:</td>
          <td align="left"><textarea name="tblfindingsub_suggest" cols="60" rows="35" style="width: 200px; height: 100px;"><?php echo ($vol['tblfindingsub_suggest']); ?></textarea></td>
        </tr>
        </tbody>
      </table>
      <div class="page_btm">
