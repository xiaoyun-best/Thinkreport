...
<div class="right"  id="mainFrame">
    <div class="right_cont">
        ...
        <!-- 添加 -->
        <form method="post" action="/Admin/Study/studyedit" name='cform' enctype="multipart/form-data">
            <input name='id' type="hidden" value="<?php echo ($vol['tblstudy_id']); ?>">
            <table>
                <tbody>
                <tr>
                    <!--左边表格-->
                    <td>
                        <table>
                            ...
                            <tr>
                                ...
                                <td align="left"><input name="tblpatient_PID" type="text" value="<?php echo ($vol['tblpatient_pid']); ?>"></td></td>
                            </tr>
                            <tr>
                                <td align="right">姓名*</td>
                                <td align="left"><input name="tblpatient_name" type="text" value="<?php echo ($vol['tblpatient_name']); ?>"></td>
                            </tr>
                            <tr>
                                <td align="right">性别*</td>
                                <td align="left">
                                    <select name="tblpatient_sex" style="width:163px;">
                                        <?php if(is_array($sexs)): foreach($sexs as $key=>$sex): if($key==$vol['tblpatient_sex']): ?><option value="<?php echo ($key); ?>" selected="selected"><?php echo ($sex); ?></option>
                                                <?php else: ?>
                                                <option value="<?php echo ($key); ?>"><?php echo ($sex); ?></option><?php endif; endforeach; endif; ?>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">年龄*</td>
                                <td align="left"><input name="age" type="text" value="<?php echo ($age); ?>" ></td>
                            </tr>
                            <tr>
                                <td align="right">生日</td>
                                <td align="left"><input name="tblpatient_birthday" type="text" value="<?php echo ($vol['tblpatient_birthday']); ?>"></td>
                            </tr>
                            <tr>
                                <td align="right">住院号</td>
                                <td align="left"><input name="tblstudy_hospitalizedID" type="text" value="<?php echo ($vol['tblstudy_hospitalizedid']); ?>"></td>
                            </tr>
                            <tr>
                                <td align="right">门诊号</td>
                                <td align="left"><input name="tblstudy_outpatientID" type="text" value="<?php echo ($vol['tblstudy_outpatientid']); ?>"></td>
                            </tr>
                            <tr>
                                <td align="right">检查类型</td>
                                <td align="left"><input name="tblstudy_modality" type="text" value="<?php echo ($vol['tblstudy_modality']); ?>"></td>
                            </tr>
                            <tr>
                                ...
                                <td align="left">
                                    <select name="tbldepartment_ID" style="width:163px;">
                                        <option value=""></option>
                                        <?php if(is_array($department)): foreach($department as $key=>$depart): if($depart['tbldepartment_id'] == $vol['tbldepartment_id']): ?><option value="<?php echo ($depart["tbldepartment_id"]); ?>" selected="selected"><?php echo ($depart["tbldepartment_department"]); ?></option>
                                                <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <select name="tbltracer_ID" style="width:163px;">
                                        <option value=""></option>
                                        <?php if(is_array($tracer)): foreach($tracer as $key=>$trac): if($trac['tbltracer_id'] == $vol['tbltracer_id']): ?><option value="<?php echo ($trac["tbltracer_id"]); ?>" selected="selected"><?php echo ($trac["tbltracer_tracer"]); ?></option>
                                                <?php else: ?>
                                                <option value="<?php echo ($trac["tbltracer_id"]); ?>"><?php echo ($trac["tbltracer_tracer"]); ?></option><?php endif; endforeach; endif; ?>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">剂量(mCi)*</td>
                                <td align="left"><input name="tblstudy_dose" type="text" value="<?php echo ($vol['tblstudy_dose']); ?>"></td>
                            </tr>
                            <tr>
                                <td align="right">登记时间</td>
                                <td align="left"><input name="tblpatient_tm"  value="<?php echo ($vol['tblpatient_tm']); ?>" class="Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" type="text"></td>
                            </tr>
                            <tr>
                                <td align="right">检查时间</td>
                                <td align="left"><input name="tblstudy_studyDate" value="<?php echo ($vol['tblstudy_studydate']); ?>" class="Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" type="text"></td>
                            </tr>
                            <tr>
                                <td align="right">病理结果</td>
                                <td align="left"><input name="tblstudy_pathological" value="<?php echo ($vol['tblstudy_pathological']); ?>" type="text"></td>
                            </tr>
                            <tr>
                                <td align="right">医嘱</td>
                                <td align="left">
                                        <textarea name="tblstudy_doctoradvice" cols="60" rows="35" style="width: 162px; height: 80px;"><?php echo ($vol['tblstudy_doctoradvice']); ?></textarea>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="left">
                                    <select name="tblstudy_ischarges" style="width:163px;">
                                        <?php if(is_array($changes)): foreach($changes as $key=>$change): if($key==$vol['tblstudy_ischarges']): ?><option value="<?php echo ($key); ?>" selected="selected"><?php echo ($change); ?></option>
                                                <?php else: ?>
                                                <option value="<?php echo ($key); ?>"><?php echo ($change); ?></option><?php endif; endforeach; endif; ?>
                                    </select>
                                </td>
                            </tr>
                            </tbody>
                    ...
                    <td>
                        <table>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <input name="tblstudy_SID" type="text" value="<?php echo ($vol['tblstudy_sid']); ?>">
                                    <input name="build" value='1' type="checkbox">生成
                                </td>
                            </tr>
                            <tr>
                                <td align="right">姓名拼音*</td>
                                <td align="left"><input name="tblpatient_pinyin" type="text" value="<?php echo ($vol['tblpatient_pinyin']); ?>"></td>
                            </tr>
                            <tr>
                                <td align="right">身高(cm)</td>
                                <td align="left"><input name="tblpatient_height" type="text" value="<?php echo ($vol['tblpatient_height']); ?>"></td>
                            </tr>
                            <tr>
                                <td align="right">体重(kg)*</td>
                                <td align="left"><input name="tblpatient_weight" type="text" value="<?php echo ($vol['tblpatient_weight']); ?>"></td>
                            </tr>
                            <tr>
                                <td align="right">电话</td>
                                <td align="left"><input name="tblpatient_tel" type="text" value="<?php echo ($vol['tblpatient_tel']); ?>"></td>
                            </tr>
                            <tr>
                                <td align="right">床号</td>
                                <td align="left"><input name="tblstudy_sickbedID" type="text" value="<?php echo ($vol['tblstudy_sickbedid']); ?>"></td>
                            </tr>
                            <tr>
                                <td align="right">影像号</td>
                                <td align="left"><input name="tblstudy_imageID" type="text" value="<?php echo ($vol['tblstudy_imageid']); ?>"></td>
                            </tr>
                            <tr>
                                <td align="right">血糖</td>
                                <td align="left"><input name="tblstudy_BloodSugarLevels" type="text" value="<?php echo ($vol['tblstudy_bloodsugarlevels']); ?>"></td>
                            </tr>
                            <tr>
                                ...
                                <td align="left">
                                    <select name="tblInpatientArea_ID" style="width:163px;">
                                        <option value=""></option>
                                        <?php if(is_array($inpatientarea)): foreach($inpatientarea as $key=>$area): if($area.tblinpatientarea_id==$vol.tblinpatientarea_id): ?><option value="<?php echo ($area["tblinpatientarea_id"]); ?>" selected="selected"><?php echo ($area["tblinpatientarea_area"]); ?></option>
                                                <?php else: ?>
                                                <option value="<?php echo ($area["tblinpatientarea_id"]); ?>"><?php echo ($area["tblinpatientarea_area"]); ?></option><?php endif; endforeach; endif; ?>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="left">
                                    <select name="tblInspectionItem_ID" style="width:163px;">
                                        <option value=""></option>
                                        <?php if(is_array($inspectionitem)): foreach($inspectionitem as $key=>$item): if($item.tblinspectionitem_id==$vol.tblinspectionitem_id): ?><option value="<?php echo ($item["tblinspectionitem_id"]); ?>" selected="selected"><?php echo ($item["tblinspectionitem_item"]); ?></option>
                                                <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <select name="tblstudy_reportState" style="width:163px;">
                                        <option value=""></option>
                                        <?php if(is_array($statuscolor)): foreach($statuscolor as $key=>$status): if($status['tblstatuscolor_id']==$vol['tblstudy_reportstate']): ?><option value="<?php echo ($status["tblstatuscolor_id"]); ?>" selected="selected"><?php echo ($status["tblstatuscolor_name"]); ?></option>
                                                <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td align="left"><input name="tblstudy_injectionDate" value="<?php echo ($vol['tblstudy_injectiondate']); ?>" class="Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" type="text"></td>
                            </tr>
                            <tr>
                                <td align="right">临床诊断</td>
                                <td align="left"><input name="tblstudy_clinical" type="text" value="<?php echo ($vol['tblstudy_clinical']); ?>"></td>
                            </tr>
                            <tr>
                                <td align="right">检查目的</td>
                                <td lign="left"><input name="tblstudy_s_destination" type="text" value="<?php echo ($vol['tblstudy_s_destination']); ?>"></td>
                            </tr>
